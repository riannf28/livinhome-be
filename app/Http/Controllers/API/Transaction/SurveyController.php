...
use App\Models\Transaction\ReasonCancel;
...
class SurveyController extends Controller
{
    ...
    public function index()
    {
        try {
            $user = Auth::user();
            $data = Survey::where('user_id', $user->id)->get();
    ...
    public function detail($id)
    {
        try {
            $user = Auth::user();
            $data = Survey::where('user_id', $user->id)->where('property_id', $id)->get();
    ...
    public function submit_survey(Request $request)
    {
        ...
        try {
            ...
            // $check_data_exist_datetime = ResponseFormatter::timestampToDate($check_data_exist_datetime);
            // dd($check_data_exist_datetime);
            ...
            // dd(ResponseFormatter::timestampToDate($request->tanggal), $request->all());
            $data = new Survey();
    ...
    public function edit_submit_survey(Request $request)
    {
        ...
        try {
            ...
            // $check_exist_data = Survey::where('user_id', $user->id)->where('property_id', (int) $request->property_id)->where('tanggal', $request->tanggal)->first();
            $check_exist_data = Survey::where('user_id', $user->id)->where('property_id', (int) $request->property_id)->first();
            $check_data_exist_datetime = Survey::query();
